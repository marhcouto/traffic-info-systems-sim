...
class NetworkModel(Model):
    ...
    def __init__(self, num_vehicles_s: int, start_node, end_node, nodes: list, roads : list,  prob_gps : float, gps_delay, alpha : float = 0.15, beta : float = 4):
    ...
    #!
    # \brief Gets the graph of the model.
